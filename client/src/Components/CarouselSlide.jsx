  ...
  return (
    <div className="md:w-auto w-full flex md:flex-row flex-col gap-7 mx-auto md:h-[350px] h-[550px] overflow-hidden">
      ...
      <div className="flex flex-col md:gap-10 gap-6">
        <h2 className="md:text-5xl font-inter text-3xl w-fit text-blue-800 dark font-semibold md:self-auto self-center relative after:content-[' '] after:w-[60%] after:h-1 rounded-full after:bg-purple-500 dark:after:bg-white after:absolute after:-bottom-3 after:left-0">
          {details.title}
        </h2>
